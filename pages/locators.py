...
class MainPageLocators:
    ...
    ADD_ITEM_BTN = (
        By.XPATH,
        "//div[@class='product_price']//button[@class='btn btn-primary btn-block']",
    )
...
class LoginPageLocators:
    LOGIN_FORM = (
        By.CSS_SELECTOR,
        "#login_form",
    )  # CSS_SELECTOR если стоит # это значит что мы ищем по id
...
class BasePageLocators:
    USER_ICON = (
        By.CSS_SELECTOR,
        ".icon-user",
    )  # CSS_SELECTOR если стоит . это значит что мы ищем по class
